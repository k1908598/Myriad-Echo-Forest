...
let floorX;
let floorY;
let minHeight;//height of ground
...
function setup() {
   ...
   //player.visible=false;
    ...
    floorX = width/2;
   floorY = pHeight - (player.height * 3.5)*0.65;
   minHeight = floorY+1;
...
function screen3() {
 ...
 //   drawPlatformer();
    ...
    let scaledHeight = pHeight * width / 1900;
    //let floorY = height + scaledHeight / 2 ;
    ...
    let y = height - (pHeight * width / 1900) / 2; // it is 827 here
    ...
    console.log("this is picture's height," ,pHeight);
